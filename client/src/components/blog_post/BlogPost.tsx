      ...
      <div className="card custom-card mb-4 mt-4">
        ...
        <div className="d-flex gap-5 mb-3">
          ...
          <p className="card-text">
            ...
            Morbi blandit cursus risus at ultrices mi tempus imperdiet. Libero enim sed faucibus turpis in. Cursus mattis molestie a iaculis at erat. Nibh cras pulvinar mattis nunc sed blandit libero. Pellentesque elit ullamcorper dignissim cras tincidunt.
